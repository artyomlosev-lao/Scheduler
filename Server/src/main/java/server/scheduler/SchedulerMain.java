...
public class SchedulerMain{
	...
	/*
	* Планирование расписания - сложная проблема, которую лучше всего решить
	* с использованием генетических алгоритмов (искусственного интеллекта).
	* Здесь испоельзуются следующие концепции: кодирование перстановок, элитарность, выбор колеса рулетки,
	* одиночный кроссовер pt, своп-мутация
	*/
